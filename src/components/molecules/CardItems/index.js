      ...
      <Col className="mb-4">
        <Card className="mr-0 ml-0">
          <Row className="no-gutters h-100">
            <Col className="col-md-4 ml-3 d-flex align-items-center">
            ...
            <Col>
              <Card.Body>
                ...
                <Button variant="info" className={btnClassEdit}>Edit</Button>
                <Modals buttonHandleText="Delete" variant="danger" buttonModal={btnClassModal} modalTitle="Delete Post" modalBody="Are you sure want to delete this post ?" />
              </Card.Body>
            </Col>
          </Row>
          <Card.Footer>
